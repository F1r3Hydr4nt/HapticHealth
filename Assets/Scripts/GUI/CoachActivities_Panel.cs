...
public class CoachActivities_Panel: MonoBehaviour
{
	/***
	 * Description:
	 * Skill class
	...
	public void Refresh_panel()
	{
		...
		//Translations
		heading_title.GetComponent<Text> ().text= translations.getString ("activities");
		...
		List<Activity> activities = coach.activities;
		...
		for (int i = 0; i < itemCount; i++)
		{
			...
			if (activity.feedbacks.Count==0)
			{
				...
				GameObject.Find("cca_button_edit_feedback").GetComponent<Button> ().GetComponentsInChildren<Text> () [0].text = translations.getString ("add_feedback");
			}
			else
			{
				GlobalVariables.selected_feedback_id = feedbacks[0].id; 
				GameObject.Find("cca_feedback").GetComponent<Text> ().text=activity.feedbacks[0].text;
				GameObject.Find("cca_button_edit_feedback").GetComponent<Button> ().GetComponentsInChildren<Text> () [0].text = translations.getString ("edit_feedback");
			}
			
			GameObject.Find("cca_button_view_activity").GetComponent<Button> ().GetComponentsInChildren<Text> () [0].text = translations.getString ("view");
			GameObject.Find("cca_label_skill").GetComponent<Text> ().text=translations.getString ("skill");
			GameObject.Find("cca_label_score").GetComponent<Text> ().text=translations.getString ("score");
			GameObject.Find("cca_label_feedback").GetComponent<Text> ().text=translations.getString ("feedback");
			GameObject.Find("cca_label_team").GetComponent<Text> ().text=translations.getString ("team");
			GameObject.Find("cca_label_club").GetComponent<Text> ().text=translations.getString ("club");
			...
			GameObject.Find("cca_label_player_name").GetComponent<Text> ().text=player_name+" "+player_surname;
			GameObject.Find("cca_skill").GetComponent<Text> ().text=skill_name;
			
			GameObject.Find("cca_score").GetComponent<Text> ().text=score.ToString();
			GameObject.Find("cca_label_datetime").GetComponent<Text> ().text=datetime;
			...
			GameObject.Find("cca_image").GetComponent<RawImage> ().texture=image;
			...
			foreach (Button button in buttons)
			{
				...
				if (button.name=="cca_button_view_activity")
				{
				...
				else if (button.name=="cca_button_edit_feedback")
				{
