...
public class Child_SkillList : MonoBehaviour
{
	/***
             * Description:
	...
	{
		_skill_canvas.active = false;
	}
	public void Show_panel()
	{
		_skill_canvas.active = true;
		Refresh_panel();
	...
	public void Refresh_panel()
	{
		...
		Debug.Log("skills REFRESH PANEL");
		...
		for (int i = 0; i < itemCount; i++)
		{
			...
			button.onClick.AddListener(() =>
				...
				play_and_learn_scenario.GoToHeroes();
